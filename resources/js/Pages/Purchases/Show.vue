                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        ...
                                        <div class="p-2 w-full mx-auto">
                                            <div class="relative">
                                                ...
                                                <div id="date" name="date" required  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="my-8 w-full mx-auto overflow-auto">
                                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">商品名</th>
                                                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">金額</th>
                                                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">数量</th>
                                                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">小計</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    <tr v-for="item in props.items" :key="item.id">
                                                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ item.item_id }}</td>
                                                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ item.item_name }}</td>
                                                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ item.item_price }}</td>
                                                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ item.quantity }}</td>
                                                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ item.subtotal }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
