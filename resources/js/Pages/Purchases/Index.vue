                          ...
                          <table class="table-auto w-full text-left whitespace-no-wrap">
                            <thead>
                              <tr>
                                ...
                                <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">購入日</th>
                              </tr>
                            </thead>
                            <tbody>
                                <tr v-for="order in props.orders.data" :key="order.id">
                                    <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ order.id }}</td>
