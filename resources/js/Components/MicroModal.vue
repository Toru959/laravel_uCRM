        ...
        <main class="modal__content" id="modal-1-content">
            <div v-if="customers.value" class="lg:w-2/3 w-full mx-auto overflow-auto">
                ...
                <thead>
                    ...
                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">カナ</th>
                ...
                <tbody>
                    <tr v-for="customer in customers.value.data" :key="customer.id">
                        ...
                        <td class="border-b-2 border-gray-200 md:px-4 py-3">{{ customer.tel }}</td>
                    </tr>
                </tbody>
                </table>
            </div>
...
<button @click="searchCustomers" type="button" data-micromodal-trigger="modal-1" class="text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">検索する</button>
</template>